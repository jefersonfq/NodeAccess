...
export const TestConnectionResultSchema = z.object({
  ...
  message:   z.string(),
  route: z.enum(['direct', 'user_agent', 'tenant_agent']).optional(),
  routeLabel: z.string().optional(),
  agentName: z.string().nullable().optional(),
  agentSource: z.enum(['user', 'tenant']).nullable().optional(),
  fallbackUsed: z.boolean().optional(),
  failureStep: z.enum(['agent', 'bastion', 'ssh', 'credential', 'validation']).nullable().optional(),
})
